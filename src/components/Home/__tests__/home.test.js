...
describe('HOME TESTING', () => {
  const MockedOwnerName = "Ilyaçe Regaibi", MockedGetOwnerName = () => {};

  const wrapper = shallow(<Home getOwnerName={MockedGetOwnerName} ownerName={MockedOwnerName} />);
  ...
  it('should render a header with App-header class', () => {
    ...
    expect(header.contains(<h1>Hello world, this is react-redux-pwa-skeleton by Ilyaçe Regaibi</h1>)).toBeTruthy();
